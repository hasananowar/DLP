...
#Hasan
def modified_evaluate_model_link_prediction(model_name: str, model: nn.Module, neighbor_sampler: NeighborSampler, evaluate_idx_data_loader: DataLoader,
    ...
    with torch.no_grad():
        ...
        for batch_idx, evaluate_data_indices in enumerate(evaluate_idx_data_loader_tqdm):
            ...
            all_preds.append(predicts.detach().cpu())
    ...
    return evaluate_losses, evaluate_metrics, torch.cat(all_preds), torch.cat(all_labels)
