...
parser.add_argument('--dataset_name', type=str, choices=['wikipedia', 'reddit', 'mooc', 'lastfm', 'enron', 'SocialEvo', 'uci',
                                                        ...
                                                        'FILT_HB_DIST', 'FILT_HB_ANGLE', 'flavanone_DIST', 'flavanone_ANGLE', 
                                                        'benzoin_DIST', 'benzoin_ANGLE'],
...
if args.dataset_name in ['enron', 'SocialEvo', 'uci']:
    ...
    #Hasan
    if args.dataset_name not in ['myket','FILT_HB_DIST', 'FILT_HB_ANGLE', 'flavanone_DIST', 'flavanone_ANGLE', 
                                 'benzoin_DIST', 'benzoin_ANGLE']:
